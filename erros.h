...
//#define ERRO_INSERIR_VALOR_INT -24
#define ERRO_PAGINA_INVALIDA NULL
#define ERRO_DE_LEITURA NULL
#define ERRO_PARAMETRO NULL
#define ERRO_COLOCA_TUPLA_BUFFER -14
#define ERRO_VALOR_NAO_EXISTENTE -15
#define ERRO_ATR_TABELA_NAO_EXISTENTE -16
#define ERRO_TABELA_INEXISTENTE -17
#define ERRO_VALOR_INEXISTENTE -18
