// TRATAMENTO DE ERROS 
#define SUCCESS 0
#define CHAVE_NORMAL 1
#define CHAVE_PRIMARIA 2
#define CHAVE_ESTRANGEIRA 3
...
#define FK_NAO_EXISTE -14
#define ERRO_ATRIB_NAO_EXISTENTE -15
#define ERRO_TABELA_INEXISTENTE -16
#define ERRO_ABRIR_ESQUEMA_INT -17
#define ERRO_DE_ALOCACAO_INT -18
#define ERRO_COLOCA_TUPLA_BUFFER_INT -19
#define ERRO_PARAMETRO_INT -20
#define ERRO_VIOLACAO_FK -21
#define ERRO_VIOLACAO_PK -22
#define ERRO_VALOR_NAO_EXISTENTE -23
